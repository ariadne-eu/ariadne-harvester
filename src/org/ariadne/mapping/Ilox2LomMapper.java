...
public class Ilox2LomMapper extends GenericMapper {
	...
	public static Element mapLom2Ilox(Element metadata) throws Exception {
		if( transformer == null) {
			transformer = new XslTransformer(PropertiesManager.getInstance().getProperty("mapper.Ilox2LomMapper.transformer_xsl_path"));
		}
